                ...
                {items.map((item) => (
                  <tr className="border-t align-top" key={item.id}>
                    <td className="p-3">
                      ...
                      {item.dataClassification === 'TEST' && <span className="mt-1 inline-block border border-amber-400 px-1 text-[11px] font-semibold">TEST</span>}
                    </td>
                    <td className="p-3">
