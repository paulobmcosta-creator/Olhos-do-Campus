# Roteiro de Homologação Manual — Versão 0.7.6

Este documento estabelece o roteiro de testes e verificações manuais para homologação da versão **0.7.6** do **Sistema Institucional de Manutenção da Infraestrutura Física**.

---

## 1. Objetivos da Homologação 0.7.6
